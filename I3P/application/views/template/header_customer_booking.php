		...
		<nav class="navbar">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle textwhite" data-toggle="dropdown" href="#"><?php echo $this->session->userdata('logged_in_customer')['username']; ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li>
